...
const DistanceCart = () => {
  ...
  return (
    distance?.trim()&&<div className='h-full w-full pt-4'>
      <ul className={'z-20 bg-white text-center border w-full grid grid-cols-2 p-2 tex-gray-400 text-gray-600 gap-2'}>
