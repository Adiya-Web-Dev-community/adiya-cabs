export const aboutQuerys = {
  "our-journey": {
    img: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    matter: (
      <div className="space-y-6 font-montserrat text-slate-500 text-sm">
        ...
        <div>
          ...
          <p className="space-y-3 flex flex-col">
            <span>
              Integrated with electronic meters and GPS/GPRS systems, India for
              the very first time was enabled to hire AC taxis over the phone!
              History was made, and so, the first fleet of the nation’s modern
              Radio Cabs headed out to conquer the ride hailing market in India
              from bustling streets of Mumbai.
            </span>
            <span>
  ...
  "our-services": {
    img: "https://images.unsplash.com/photo-1507722661946-ec4abdfe6a1e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2013&q=80",
    matter: (
      <div className="space-y-6 font-montserrat text-slate-500 text-sm">
        <p className="mt-3">
          ...
          <ul className="space-y-3 list-disc list-outside">
            <li className="ml-4">
              ...
              <p>
                ...
                All our cabs are equipped with GPRS based safety features like
                ICE alerts, trip tracker and more. With our 24/7 contact center,
                we offer assistance at all times during your ride.
              </p>
            </li>
            <li className="ml-4">
              ...
              <p>
                ...
                as Mumbai, Delhi, Bengaluru and Hyderabad, for almost a decade
                and more. Simply reach out to our booking counters / manager at
                airports.
              </p>
            </li>
            <li className="ml-4">
  ...
  "our-investors": {
    img: "https://images.unsplash.com/photo-1471479917193-f00955256257?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1931&q=80",
    matter: (
      <div className="space-y-6 font-montserrat text-slate-500 text-sm">
        <p className="mt-3">
          Not to brag, but Adiya Cab initiated the ride- hailing revolution in India
